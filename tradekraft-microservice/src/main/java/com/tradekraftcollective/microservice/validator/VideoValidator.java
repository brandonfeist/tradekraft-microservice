...
//    }
//
    public void validateVideoFile(MultipartFile videoFile) {
...
//        return (hasMultipart || video.getVideoFiles() != null);
//    }


    public Video validateVideoSlug(String videoSlug) {
        Video video = videoRepository.findBySlug(videoSlug);
